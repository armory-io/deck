...
import { DEFAULT_GITREPO_ARTIFACT } from './gitrepo/defaultGitRepo.artifact';
...
import { GITREPO_ARTIFACT } from 'core/pipeline/config/triggers/artifacts/gitrepo/gitrepo.artifact';
